...
class MLEndpoint(models.Model):
    """
    This model represents ML API endpoint.
...
class MLAlgorithm(models.Model):
    """
    The MLAlgorithm represents the Machine Learning algorithm object.
    ...
    owner = models.CharField(max_length=128)
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    parent_endpoint = models.ForeignKey(MLEndpoint, on_delete=models.CASCADE)
...
class ABTest(models.Model):
    '''
    The ABTest keeps information about A/B tests.
    Attributes:
